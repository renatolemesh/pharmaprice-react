  ...
  return (
    <div className="gradient-background min-h-screen">
      ...
      <footer className="border-t border-border/60 pt-8 pb-24 sm:pb-8">
        <div className="mx-auto flex max-w-6xl flex-col items-center gap-4 px-4 text-center text-xs text-muted-foreground sm:flex-row sm:items-start sm:justify-between sm:px-6 sm:text-left">
          ...
          <p className="shrink-0">
            ...
            <a
              ...
              target="_blank"
              rel="noopener noreferrer"
              className="inline-flex items-center gap-1.5 font-medium text-foreground transition-smooth hover:text-dashboard-primary"
            >
