 ...
 *
 * O número fica aqui e não numa variável de ambiente porque esta página é
 * estática e o número é público — é o ponto da página. `wa.me` é o formato
 * oficial e resolve sozinho entre app e web conforme o aparelho.
 */
const WHATSAPP = "5541988369266";
const WHATSAPP_MENSAGEM = "Olá! Vim pelo site do PharmaPrice.";
const whatsappUrl = `https://wa.me/${WHATSAPP}?text=${encodeURIComponent(WHATSAPP_MENSAGEM)}`;

/* Ícone da marca. O lucide não traz logotipos de terceiros, então o traçado
   vem inline — é o glifo oficial, em cor única. */
...
/** Botão flutuante de contato, visível em qualquer altura da rolagem. */
const BotaoWhatsApp = () => (
  <a
    href={whatsappUrl}
    target="_blank"
    ...
    /* z-40 fica acima do cabeçalho fixo (z-30). O verde é o da marca, não um
       token do tema: ele não muda entre claro e escuro. */
    className="fixed bottom-5 right-5 z-40 inline-flex h-14 w-14 items-center justify-center rounded-full text-white shadow-hover transition-smooth hover:scale-105 focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-[#25D366] sm:bottom-6 sm:right-6"
...
const Landing = () => {
  ...
  return (
    <div className="gradient-background min-h-screen">
      ...
      {/* `pb-24` no mobile: o botão flutuante fica sobre o canto inferior
          direito e cobria a última linha do rodapé. */}
      <footer className="border-t border-border/60 pt-8 pb-24 sm:pb-8">
